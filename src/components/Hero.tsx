    ...
    <section className="relative min-h-[90vh] flex items-center overflow-hidden" style={{ background: 'linear-gradient(135deg, hsl(220, 20%, 12%) 0%, hsl(220, 18%, 18%) 100%)' }}>
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-4xl">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/30 border border-primary/50 mb-8 animate-fade-in">
          ...
          <div className="flex flex-wrap gap-3 mb-10 animate-slide-up" style={{ animationDelay: "0.2s" }}>
            {[
              ...
              <span
                key={service}
                className="px-4 py-2 rounded-full bg-white/10 border border-white/20 text-sm text-hero-muted"
              >
                {service}
              </span>
            ))}
          ...
          <div className="flex flex-col sm:flex-row gap-4 animate-slide-up" style={{ animationDelay: "0.3s" }}>
            ...
            <Link to="/servicios">
              <Button size="lg" variant="outline" className="border-white/40 text-hero bg-white/10 hover:bg-white/20 font-semibold text-lg px-8 h-14">
                Ver Servicios
              </Button>
            </Link>
          </div>
          ...
          <div className="grid grid-cols-3 gap-8 mt-16 pt-16 border-t border-white/10 animate-slide-up" style={{ animationDelay: "0.4s" }}>
            <div>
              ...
              <p className="text-3xl font-bold text-hero">+20</p>
              <p className="text-sm text-hero-muted">Años de Experiencia</p>
            </div>
            <div>
              <div className="flex items-center gap-2 mb-2">
                <Flame className="h-6 w-6 text-primary" />
              </div>
              <p className="text-3xl font-bold text-hero">100%</p>
              <p className="text-sm text-hero-muted">Certificados SEC</p>
            </div>
            <div>
              <div className="flex items-center gap-2 mb-2">
                <ShieldCheck className="h-6 w-6 text-secondary" />
              </div>
              <p className="text-3xl font-bold text-hero">500+</p>
              <p className="text-sm text-hero-muted">Proyectos Realizados</p>
            </div>
          </div>
        </div>
      </div>
